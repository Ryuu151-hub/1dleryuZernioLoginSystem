...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Explicit user action: always start a fresh TikTok OAuth authorization.
    // Reuse the existing Zernio profile when available, but never short-circuit
    // back to the frontend just because this browser already has a session.
